...
// EXTERNAL MODULE: /Users/skyyao/local/react-tyao1/build/oss-experimental/react-debug-tools/index.js
...
function attach(hook, rendererID, renderer, global) {
  ...
  function getStringID(string) {
    ...
    var encodedString = Object(utils["n" /* utfEncodeString */])(string);
...
function Q(a, b, d) {
  var c,
      ...
      l = null,
      k = null;
  if (null != b) for (c in void 0 !== b.ref && (k = b.ref), void 0 !== b.key && (l = "" + b.key), b) {
    N.call(b, c) && !P.hasOwnProperty(c) && (e[c] = b[c]);
  }
  var h = arguments.length - 2;
  if (1 === h) e.children = d;else if (1 < h) {
    for (var f = Array(h), m = 0; m < h; m++) {
      f[m] = arguments[m + 2];
    }
...
function R(a) {
  return "object" === _typeof(a) && null !== a && a.$$typeof === g;
}
...
function U(a, b, d, c, e) {
  ...
  if (M(a)) for (var h = 0; h < a.length; h++) {
    ...
    var f = c + T(l, h);
    k += U(l, b, d, f, e);
  } else if (f = ba(a), "function" === typeof f) for (a = f.call(a), h = 0; !(l = a.next()).done;) {
    l = l.value, f = c + T(l, h++), k += U(l, b, d, f, e);
  } else if ("object" === l) throw b = String(a), Error("Objects are not valid as a React child (found: " + ("[object Object]" === b ? "object with keys {" + Object.keys(a).join(", ") + "}" : b) + "). If you meant to render a collection of children, use an array instead.");
  return k;
}
...
exports.cloneElement = function (a, b, d) {
  ...
  if (null != b) {
    ...
    for (f in b) {
      N.call(b, f) && !P.hasOwnProperty(f) && (c[f] = void 0 === b[f] && void 0 !== h ? h[f] : b[f]);
    }
  }
...
exports.version = "18.3.0-experimental-6e3bc8a2e-20220916";
...
// EXTERNAL MODULE: /Users/skyyao/local/react-tyao1/node_modules/lodash.throttle/index.js
...
// CONCATENATED MODULE: /Users/skyyao/local/react-tyao1/node_modules/memoize-one/esm/index.js
...
function renderer_attach(hook, rendererID, renderer, global) {
  ...
  function flushPendingEvents(rootID) {
    ...
    pendingStringTable.forEach(function (value, key) {
      ...
      var encodedKey = Object(src_utils["n" /* utfEncodeString */])(key);
    ...
    if (constants["s" /* __DEBUG__ */]) {
      Object(src_utils["k" /* printOperationsArray */])(operations);
  ...
  function renamePath(type, id, hookID, oldPath, newPath) {
    ...
    if (internalInstance != null) {
      ...
      if (publicInstance != null) {
        switch (type) {
          case 'context':
            Object(src_utils["l" /* renamePathInObject */])(publicInstance.context, oldPath, newPath);
            forceUpdate(publicInstance);
            break;
          ...
          case 'state':
            Object(src_utils["l" /* renamePathInObject */])(publicInstance.state, oldPath, newPath);
            forceUpdate(publicInstance);
            break;
        }
      }
  ...
  function overrideValueAtPath(type, id, hookID, path, value) {
    ...
    if (internalInstance != null) {
      ...
      if (publicInstance != null) {
        switch (type) {
          case 'context':
            Object(src_utils["m" /* setInObject */])(publicInstance.context, path, value);
            forceUpdate(publicInstance);
            break;
          ...
          case 'state':
            Object(src_utils["m" /* setInObject */])(publicInstance.state, path, value);
            forceUpdate(publicInstance);
            break;
        }
      }
